        ...
        <div className="flex">
          ...
          <div>
            ...
            <Routes>
              ...
              <Route
                path="ValidationManagement"
                element={<ValidationManagement />}
              />
            </Routes>
          </div>
        </div>
